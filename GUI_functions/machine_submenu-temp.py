# machine_submenu.py
# This program may no longer be needed
...
check2 = tk.Checkbutton(win, text="This machine has all necessary toolkits installed.", variable=chVarEn)
check2.deselect()
...
check9 = tk.Checkbutton(win, text="This machine requires a custom toolkit configuration.", variable=chVarEm)
check3.deselect()
